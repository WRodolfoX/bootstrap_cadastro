  ...
  <main class="form-signin">
    ...
    <form method="post" action="login.php">
      ...
      <div class="form-floating">
        <input type="email" class="form-control" name="emailPessoa" id="emailPessoa" placeholder="email">
        <label for="emailPessoa">E-mail</label>
      </div>
      <div class="form-floating">
        <input type="password" class="form-control" name="senhaPessoa" id="senhaPessoa" placeholder="Senha">
      ...
      <p class="mt-5 mb-3"><a href="recuperar.php">Esqueci a senha</a></p>
